INSERT INTO silver.crm_customer_info (cst_id,cst_key,cst_firstname,cst_lastname,cst_material_status,cst_gndr,cst_create_date)
SELECT 
	cst_id,
	cst_key,
...
SELECT
    CASE
        WHEN cid LIKE 'NAS%' THEN SUBSTRING(cid, 4)   -- Remove 'NAS'
        ELSE cid
    END AS cid,

    CASE
        WHEN bdate > CURDATE() THEN NULL              -- Replace future dates with NULL
        ELSE bdate
    END AS bdate,
